...
class Bunny extends FlxSprite
{
	...
	public function new()
	{
		...
		if (FlxG.renderBlit)
			loadRotatedGraphic(Global.asset("assets/wabbit_alpha.png"), 16, -1, false, true);
		else
			loadGraphic(Global.asset("assets/wabbit_alpha.png"));
	}
